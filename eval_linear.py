...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_weights', default=f'./checkpoints/mean_patch32_out1000_tiny_cifar10_chatgpt/checkpoint.pth', type=str, help="Path to pretrained weights to evaluate.")
    ...
    parser.add_argument('--batch_size_per_gpu', default=2500, type=int, help='Per-GPU batch-size')
    ...
    parser.add_argument('--output_dir', default=f"./checkpoints/mean_patch32_out1000_tiny_cifar10_chatgpt_cifar10", help='Path to save logs and checkpoints')
