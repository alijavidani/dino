...
def get_args_parser():
    ...
    parser.add_argument('--batch_size_per_gpu', default=790, type=int,
        help='Per-GPU batch-size : number of distinct images loaded on one GPU.')
    parser.add_argument('--epochs', default=74, type=int, help='Number of epochs of training.')
    ...
    parser.add_argument('--output_dir', default="./checkpoints/optimize-memory-imagenet", type=str, help='Path to save logs and checkpoints.')
