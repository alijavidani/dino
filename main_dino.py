...
def get_args_parser():
    ...
    batch_size = parser.add_argument('--batch_size_per_gpu', default=30, type=int,
    ...
    parser.add_argument('--output_dir', default=f"/home/alij/RESULTS/Imagenet100/Ours/Network_Checkpoints/mean_patch{patch_size.default}_out{out_dim.default}_{arch.default[4:]}_fp{16 if fp16.default else 32}_batch{batch_size.default}_patch_augmentation", type=str, help='Path to save logs and checkpoints.')
